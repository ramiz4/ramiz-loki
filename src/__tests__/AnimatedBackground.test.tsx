...
describe('AnimatedBackground', () => {
  ...
  test('handles mouse move events', () => {
    ...
    ).mock.calls.find(call => call[0] === 'mousemove')[1];
  ...
  test('renders grid lines', () => {
    ...
    expect(firstGridLine.style.animation).toBe(
      'verticalLine 3s ease-in-out infinite',
    );
  });
  ...
  test('cleans up event listeners and timeouts on unmount', () => {
    ...
    const { unmount } = render(
      <AnimatedBackground imagePath="/test-image.png" />,
    );
