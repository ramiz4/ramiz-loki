...
export function ScrollToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`fixed right-6 bottom-6 z-50 p-3 rounded-full bg-[#00ff9d] shadow-lg hover:bg-[#00cc7a] transition-all duration-300 hover:scale-110 focus:outline-none ${
        isVisible
