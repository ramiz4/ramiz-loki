      ...
      <div className="flex flex-col items-center justify-center min-h-screen w-full">
        <div className="relative z-10 w-full max-w-4xl mx-auto px-4">
          <div className="text-center">
            <p className="text-primary-500 text-sm uppercase mb-6 tracking-wider font-medium animate-fade-in-up">
              {t.header.welcome}
            </p>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight animate-fade-in-up animation-delay-200">
              <span className="text-white">I'm </span>
              <span className="text-primary-600">{t.header.name}</span>
            </h1>
            <div className="h-0.5 w-16 mx-auto bg-primary-600 mb-6 animate-fade-in-up animation-delay-300"></div>
            ...
            <div className="flex items-center justify-center gap-4 mb-12 animate-fade-in-up animation-delay-500">
              <a
                ...
                className="p-3 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-primary-500 transition-all duration-300"
                target="_blank"
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-600">
              <a
                ...
                className="px-8 py-3 bg-primary-600 text-white rounded-md font-medium hover:bg-primary-700 transition-all duration-300 shadow-lg"
              >
                {t.header.contactMe}
              </a>
              <a
