  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-xl p-8 rounded-lg border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.37)] hover:bg-white/10 hover:border-white/20 transition-all duration-300">
            <h3 className="text-2xl font-bold mb-6 text-white">
              ...
              <span className="text-primary-500 relative">
                Loki
                <span className="absolute -inset-1 bg-[rgb(59 130 246)20] blur-xl"></span>
              </span>
            </h3>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="p-3 bg-transparent border border-primary-500/20 rounded-full hover:bg-primary-600/10 transition-all duration-300 group hover:scale-110"
                aria-label="Visit my LinkedIn profile"
              >
                <LinkedinIcon size={20} className="text-primary-500" />
              </a>
              <a
              ...
              >
                <SiGithub size={20} className="text-primary-500" />
              </a>
              <a
              ...
              >
                <SiStackoverflow size={20} className="text-primary-500" />
              </a>
            </div>
          </div>
          <div className="bg-white/5 backdrop-blur-xl p-8 rounded-lg border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.37)] hover:bg-white/10 hover:border-white/20 transition-all duration-300">
            ...
            <div className="space-y-6">
              <div className="flex items-center contact-info-item">
                <div className="p-3 bg-primary-600/10 rounded-full mr-4 border border-primary-500/20">
                  <MailIcon size={20} className="text-primary-500" />
                </div>
                <div>
              ...
              <div className="flex items-center contact-info-item">
                <div className="p-3 bg-primary-600/10 rounded-full mr-4 border border-primary-500/20">
                  <MapPinIcon size={20} className="text-primary-500" />
                </div>
                <div>
        ...
        {/* Divider */}
        <div className="h-px w-full mx-auto bg-gradient-to-r from-transparent via-[rgb(59 130 246)]/30 to-transparent my-12"></div>
