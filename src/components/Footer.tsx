  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-xl p-8 rounded-lg border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.37)] hover:bg-white/10 hover:border-white/20 transition-all duration-300">
            <h3 className="text-2xl font-bold mb-6 text-white">
              ...
              <span className="text-primary-500 relative">
                Loki
                <span className="absolute -inset-1 bg-primary-600/20 blur-xl"></span>
              </span>
            </h3>
        ...
        {/* Divider */}
        <div className="h-px w-full mx-auto bg-gradient-to-r from-transparent via-primary-600/30 to-transparent my-12"></div>
